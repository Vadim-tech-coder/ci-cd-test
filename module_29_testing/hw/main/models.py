...
class Parking(db.Model):
    ...
    def __repr__(self):
        return f"Парковка {self.address}, мест всего - {self.count_places}, свободно мест - {self.count_available_places}"
...
class ClientParking(db.Model):
    ...
    archived_record = db.Column(db.Boolean, default = False)
