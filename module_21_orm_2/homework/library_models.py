...
from sqlalchemy import event, create_engine, Column, Integer, String, Float, Date, Boolean, DateTime, case, func, ForeignKey
...
class Book(Base):
    ...
    students = association_proxy('received_books', 'student')
